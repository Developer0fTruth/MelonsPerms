 ...
 *                                                                            *
 ******************************************************************************/
public class UserMembershipManipulationEvent extends Event implements Cancellable {
    ...
    public UserMembershipManipulationEvent(User user, Group group, GroupAction action) {
        this.user = user;
        this.group = group;
        this.action = action;
    }
